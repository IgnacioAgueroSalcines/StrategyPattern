...
namespace Composite
{
    ...
    public abstract class Componente
    {
        ...
        public Func<String, String> filtro;

        public Componente(Func<String, String> filtro)
        {
            this.filtro = filtro;
        }
        ...
        /// <summary>
        /// Metodo que devuelve un string con informacion del archivo en base a la estrategia proporcionada
        /// </summary>
        /// <returns></returns>
