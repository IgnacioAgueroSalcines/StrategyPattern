...
namespace Composite
{
    ...
    public class Archivo: Renombrable
    {
        ...
        public Archivo(String _nombre,int _tamano, Func<String, String> filtro) : base(_nombre,filtro)
        {
            tamano = _tamano;
            nombre = _nombre;
            orden = 0;
        ...
        {
            return this.filtro(this.nombre);
        }

        
        public override String ToStringExtends()
        {
            return base.filtro("F " +this.nombre+".jpg");
        }
